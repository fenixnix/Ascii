...
//Wise players (as well as, or maybe especially, the unwise) are advised to save the game regularly, such as after putting each treasure in the trophy case and before dangerous or randomized actions.
...
In one corner of the house there is a small window which is slightly a jar.
+ Go West of House
 -> west_of_house
+ Go North of House
 -> north_of_house
...
= kitchen
#Kitchen
You are in the kitch of the white house.
...
//Open the mailbox.
//Get the leaflet and read it, then drop it.
//Go north twice to a Forest Path location and climb the tree.
//Get the egg from the nest and go back down.
//Try to open the egg, but you'll find that you can't do it. (This action is essential, otherwise the Thief won't open the egg for you later.)
//Go south and east to Behind House.
//Open the window and enter the house.
//Get the sack and bottle. 
//Open the sack and you will see it contains a lunch and a clove of garlic.
//You can either eat the lunch and drink the water, or keep them as an alternate solution for a later puzzle.
...
//For Your Amusement:
//Eat the garlic. (save first; you need it).
...
=== The_Treasure_Room_and_the_Barrow ===
